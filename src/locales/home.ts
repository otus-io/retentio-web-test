...
export const homeStrings: Record<HomeLang, HomeStrings> = {
  en: {
    ...
    heroSubtitle:
      "build decks, add facts, and review with science-backed scheduling for better retention. for any subject — languages, exams, or anything you want to remember. web and mobile.",
    ...
    whatVerifiedDesc:
      "word and phrase translations are human-verified for better accuracy and retention than raw machine output.",
    whatAlgorithm: "improved srs algorithm",
    whatAlgorithmDesc:
      "a new srs algorithm that addresses limitations of existing algorithms for more effective scheduling and better retention.",
    whatUi: "intuitive ui",
  ...
  zh: {
    ...
    help: "帮助",
    heroTagline: "用间隔重复学习",
    heroSubtitle: "创建卡组、添加词条，用科学排程复习，提升记忆保留。语言、考试或任何你想记住的内容都适用。支持网页与移动端。",
    ...
    manualTitle: "用户手册",
    manualIntro: "如何使用 Retentio：创建卡组、添加词条、复习卡片。此处内容将逐步完善。",
  },
  ja: {
    logIn: "ログイン",
    dashboard: "ダッシュボード",
